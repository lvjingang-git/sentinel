...
public class AuthorityRuleController {
    ...
    @Resource(name="authorityRuleApiPublisher")
    private DynamicRulePublisher< List<AuthorityRuleEntity>> dynamicRulePublisher;

    @Resource(name="authorityRuleApiProvider")
    ...
    public Result<List<AuthorityRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            ...
            List<AuthorityRuleEntity> rules = dynamicRuleProvider.getRules(app);
